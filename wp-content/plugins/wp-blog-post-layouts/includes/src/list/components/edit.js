 ...
 * Block View wrapper
 */
import ListOne from '../layout-one/layout-one'
import ListTwo from '../layout-two/layout-two'
import ListThree from '../layout-three/layout-three'
    ...
    render() {
        ...
        return (
            <Fragment>
                ...
                <div id="cv-list-post-layout" className={ `block-${blockID} cv-block cv-block-list--${layoutOption}` }>
                    {
                        ( () => {
                            if( !!blockTitle ) {
                    ...
                    }
                    {
                        ( () => {
                            switch( layoutOption ) {
                                case 'layout-two' : return <ListTwo { ...this.props }/>
                                case 'layout-three' : return <ListThree { ...this.props }/>
                                default: return <ListOne { ...this.props }/>
                            }
                        }) ()
                    }
                </div>
